...
ce_input_update_keyboard_state(WPARAM w_param, unsigned char state)
{
    switch (w_param)
    {
        ...
        case VK_LEFT:       keyboard_state[KEY_LEFT] = state; gamepad_state.left_stick_x = (state == 1U) ? -ANALOG_STICK_EMULATED_DEFAULT_VALUE : 0.0f; break;
        case VK_RIGHT:      keyboard_state[KEY_RIGHT] = state; gamepad_state.left_stick_x = (state == 1U) ? ANALOG_STICK_EMULATED_DEFAULT_VALUE : 0.0f; break;
        case VK_UP:         keyboard_state[KEY_UP] = state; gamepad_state.left_stick_y = (state == 1U) ? ANALOG_STICK_EMULATED_DEFAULT_VALUE : 0.0f; break;
        case VK_DOWN:       keyboard_state[KEY_DOWN] = state; gamepad_state.left_stick_y = (state == 1U) ? -ANALOG_STICK_EMULATED_DEFAULT_VALUE : 0.0f; break;
        ...
        case VK_LSHIFT:     keyboard_state[KEY_LSHIFT] = state; break;
        case VK_RSHIFT:     keyboard_state[KEY_RSHIFT] = state; break;
        case VK_LCONTROL:   keyboard_state[KEY_LCONTROL] = state; break;
        case VK_RCONTROL:   keyboard_state[KEY_RCONTROL] = state; break;
        case VK_LMENU:      keyboard_state[KEY_LALT] = state; break;
        case VK_RMENU:      keyboard_state[KEY_RALT] = state; break;
    }
}
