...
public:
    ...
    void Setup(const core::Vector3& halfSize, float mass);
    ...
    void AddForceAtPoint(const core::Vector3& force, const core::Vector3& point);
    ...
    const core::Vector3 GetVelocityAtPoint(const core::Vector3& point);
    /// take a world vector and make it a local vector
    const core::Vector3 WorldToLocal(const core::Vector3& world);
    /// take a local vector and make it a world vector
    const core::Vector3 LocalToWorld(const core::Vector3& local);
